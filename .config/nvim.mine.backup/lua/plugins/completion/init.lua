		...
		dependencies = {
			{
				...
				config = function()
					...
					local vscode_snippets_dir = vim.fn.stdpath("config")
						.. "/lua/plugins/completion/snippets/typescript/"
					require("luasnip.loaders.from_vscode").lazy_load({ path = vscode_snippets_dir })
				end,
			},
			{
				"honza/vim-snippets",
